window.onload = function () {
    ...
    function c1Ani() {
        ...
        tl.to('.outer', {
            ...
            .to('.title1-svg', { duration: 1, y: '3vw', ease: 'power2.inOut', }, '<0.2')
            .to(splitEN2[0].chars, {
                duration: 1,
                ease: 'power2.inOut',
                y: 300,
    ...
    function c2Ani() {
        ...
        tl
            ...
            .to('.c2-img,.right-text-svg,.top-small-text-box', { duration: 1, opacity: 1, ease: 'power1.inOut', }, '<0.2')
            ...
            .to('.black-box,.right-text-svg,.top-small-text-box', { duration: 2, y: '-43vw' }, '<0.3')
            .fromTo('.card3', { y: '10vw' }, { y: 0, duration: 3, opacity: 1, ease: 'power1.inOut', }, '<-0.25')
